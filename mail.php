...
try {
  ...
  $mail->Username   = 'oli.leoni@yandex.ru'; // Логин на почте
  $mail->Password   = 'jjiqvxgjmhxwxzsr'; // Пароль на почте
  $mail->SMTPSecure = 'ssl';
  $mail->Port       = 465;

  $mail->setFrom('oli.leoni@yandex.ru', 'Заявка с сайта'); // Адрес самой почты и имя отправителя

  // Получатель письма
  $mail->addAddress('oli.leoni@yandex.ru');
